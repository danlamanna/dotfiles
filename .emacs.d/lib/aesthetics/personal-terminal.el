;;; personal-terminal.el -- preferences/setup for Emacs running on the console

;;;============================================================================
;;; FONT LOCK BUILT-IN FACES

;; These faces are predefined in Emacs 22 but not Emacs 21; need to make-face
;; before we set their attribs, to prevent errors
